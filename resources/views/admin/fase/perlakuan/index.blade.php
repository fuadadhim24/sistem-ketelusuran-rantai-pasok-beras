...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            ...
            <p class="mb-0" id="fase-text">Fase (Nama Fase).</p>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow components-section">
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-form-signup">Tambah Perlakuan</button>
                </div>
                <!-- Modal Tambah -->
                                        ...
                                        <form action="#">
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="cth: Berikan pupuk hari ini" id="nama" required>
                                                </div>
                                            </div>
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon3"><span class="fas fa-envelope"></span></span>
                                                    <input type="text" class="form-control" placeholder="berlangsungnya perlakuan. cth: 10" id="durasi" required>
                                                </div>
                                            </div>
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon3"><span class="fas fa-envelope"></span></span>
                                                    <input type="text" class="form-control" placeholder="terhitung sejak awal fase. cth: 23" id="hari" required>
                                                </div>
                                            </div>
                                            <div class="d-grid">
                                                <button type="button" class="btn btn-block btn-primary mb-3 w-100" data-bs-dismiss="modal">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                  ...
                  <div class="card-body p-0 pl-lg-3">
                      <form action="#">
                          <div class="form-group mb-4">
                              ...
                              <div class="input-group">
                                  <span class="input-group-text" id="basic-addon3"><span class="fas fa-envelope"></span></span>
                                  <input type="text" class="form-control" placeholder="cth: Berikan pupuk hari ini" id="edit-nama" required>
                              </div>
                          </div>
                          <div class="form-group mb-4">
                              ...
                              <div class="input-group">
                                  <span class="input-group-text" id="basic-addon3"><span class="fas fa-envelope"></span></span>
                                  <input type="text" class="form-control" placeholder="berlangsungnya perlakuan. cth: 10" id="edit-durasi" required>
                              </div>
                          </div>
                          <div class="form-group mb-4">
                              ...
                              <div class="input-group">
                                  <span class="input-group-text" id="basic-addon3"><span class="fas fa-envelope"></span></span>
                                  <input type="text" class="form-control" placeholder="terhitung sejak awal fase. cth: 23" id="edit-hari" required>
                              </div>
                          </div>
                          <div class="d-grid">
                              <button type="button" class="btn btn-block btn-primary mb-3 w-100" data-bs-dismiss="modal">Simpan Perubahan</button>
                          </div>
                      </form>
                  </div>
              </div>
...
<!-- Modal Hapus -->
<div class="modal fade" id="modal-form-delete" tabindex="-1" role="dialog" aria-labelledby="modal-form-delete" aria-hidden="true">
...
<script>
  $(document).ready(function() {
      ...
      $('#modal-form-edit .btn-primary').click(function() {
          var id = $(this).data('id');
          console.log('Updating Perlakuan ID:', id);
