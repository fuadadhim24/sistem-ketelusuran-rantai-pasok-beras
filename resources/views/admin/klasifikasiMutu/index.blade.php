            ...
            <div class="col-12 px-0 mb-4">
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body p-2">
                        <img src="{{ asset('asset/img/admin/tabel_klasifikasi_mutu.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-12 px-0 mb-4">
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between row border-bottom pb-3">
                            <div class="col">
                                <div class="row">
                                    <div class="h6 mb-0 d-flex align-items-center">
                                        ...
                                        Daftar Hasil Pengolahan
                                    </div>
                                    <p class="mb-0">belum melalui pengujian.</p>
                                </div>
