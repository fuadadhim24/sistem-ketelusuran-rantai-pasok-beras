            ...
            <div class="card bg-yellow-100 border-0 shadow">
                <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                    <div class="d-block mb-3 mb-sm-0">
                        <div class="fs-5 fw-normal mb-2">Jumlah Pengunjung Laman</div>
                        <h2 class="fs-3 fw-extrabold">130</h2>
                        <div class="small mt-2">
                            <span class="fw-normal me-2">diakses</span>
                            <span class="fas fa-angle-up text-success"></span>
                            <span class="text-success fw-bold">hari ini</span>
                        </div>
                    </div>
                    <div class="d-flex ms-auto">
                        <a href="#" class="btn btn-secondary text-dark btn-sm me-2">Bulan ini</a>
                        <a href="#" class="btn btn-dark btn-sm me-3">Minggu ini</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">Jumlah Produk</h2>
                                <h3 class="fw-extrabold mb-1">73</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Pengujian yang dilakukan</h2>
                                <h3 class="fw-extrabold mb-2">10x</h3>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5"> Varietas Padi</h2>
                                <h3 class="mb-1">34</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
        ...
        <div class="row">
            <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
                <p class="mb-0 text-center text-lg-start">© 2019-<span class="current-year"></span> <a
                        class="text-primary fw-normal" href="https://themesberg.com" target="_blank">UD Tani Rejo</a></p>
            </div>
