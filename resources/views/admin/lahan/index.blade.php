...
@section('main')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col mb-4">
                                ...
                                <input type="number" class="form-control" id="luas" placeholder="cth: 10x50"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button id="btnTampilkan-{{ $index }}" class="btn btn-outline-warning"
                                                type="button" hidden>Tampilkan</button>
                                            <button id="btnSembunyikan-{{ $index }}"
                                                class="btn btn-outline-gray-500" type="button">Sembunyikan</button>
    ...
    {{-- aksi detail hasil panen --}}
    <script>
        const notyf = new Notyf();

        function toggleButtons() {
            var button1 = document.getElementById("btnTampilkan");
            var button2 = document.getElementById("btnSembunyikan");
            var button3 = document.getElementById("btnLoad");
