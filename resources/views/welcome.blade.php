                ...
                <div class="div-row-bg-wrap-1">
                    ...
                    <div class="container-13">
                        {{-- <div class="container-24">
                            ...
                            <span class="list-item-link-penelitian-dan-pengembangan" onclick="showContent('content2', this)">
                                Penelitian dan Pengembangan
                            </span>
                        </div> --}}
                    ...
                    <script>
                        ...
                        function showContent(contentId, element) {
                            ...
                            if (contentId === 'content1') {
                                headingContent.innerHTML = 'Membangun kemitraan dengan petani<br /> menjadi bagian penting dari bisnis kami';
                            ...
                            var links = document.querySelectorAll('.list-item-link-kemitraan-dengan-petani, .list-item-link-penelitian-dan-pengembangan, .list-item-link-benih-topaz, .list-item-link-komitmen-keberlanjutan');
