    ...
    <div class="beranda">
        <div class="header">
            ...
            <div class="list">
                ...
                <div class="item-5">
                    <div class="link-2">
                        <img class="vector-14" src="../assets/vectors/vector12_x2.svg" />
                    </div>
                </div>
            </div>
        </div>
        <div class="div-ocm-effect-wrap">
            <div class="div-container-wrap">
                ...
                <div
                    class="bisnis-kami-meliputi-pembibitan-penanaman-hingga-pengolahan-beras-untuk-menghasilkan-minyak-sawit-berkelanjutan-di-pabrik-yang-berteknologi-tinggi-dan-ramah-lingkungan">
                ...
                <div class="div-inner-wrap-5">
                    ...
                    <div
                        ...
                        UD Tani Rejo mengelola 30 perkebunan milik perusahaan yang mencakup lahan seluas 100.000 hektar
                        dan sekitar 60.000 hektar perkebunan<br />
                        dimiliki oleh petani plasma. UD Tani Rejo memastikan praktik-praktik pengembangan berkelanjutan
                    ...
                    <div class="container-1">
                        ...
                        <div class="container-14">
                            ...
                            <div class="container-6">
                                <img class="container-16" src="../assets/vectors/container_x2.svg" />
                            </div>
                        </div>
                        <div class="button-previous-svg">
                            <img class="vector-22" src="../assets/vectors/vector10_x2.svg" />
                        </div>
                ...
                <div class="div-inner-wrap">
                    <div class="container-29">
                        ...
                        <div class="container-20">
                            <div class="icon">
                                <img class="vector-1" src="../assets/vectors/vector4_x2.svg" />
                            </div>
                    ...
                    <div class="container-31">
                        <div class="container-11">
                            <div class="icon-1">
                                <img class="vector-2" src="../assets/vectors/vector2_x2.svg" />
                            </div>
                ...
                <div class="div-row-bg-wrap">
                    ...
                    <div class="container-5">
                        <div class="div-nectar-icon">
                            <img class="vector-3" src="../assets/vectors/vector15_x2.svg" />
                        </div>
                        <div class="div-nectar-icon-1">
                            <img class="vector-4" src="../assets/vectors/vector19_x2.svg" />
                        </div>
                        <div class="div-nectar-icon-2">
                            <img class="vector-5" src="../assets/vectors/vector_x2.svg" />
                        </div>
                        <div class="div-nectar-icon-3">
                            <img class="vector-6" src="../assets/vectors/vector16_x2.svg" />
                        </div>
                        <div class="div-nectar-icon-4">
                            <img class="vector-7" src="../assets/vectors/vector7_x2.svg" />
                        </div>
                    </div>
                </div>
                <div class="svg">
                    <img class="vector-21" src="../assets/vectors/vector5_x2.svg" />
                </div>
                ...
                <div class="div-column-bg-overlay-wrap">
                    <div class="icon-2">
                        <img class="vector-8" src="../assets/vectors/vector1_x2.svg" />
                    </div>
                    <div
                ...
                <div class="divcopyright">
                    ...
                    <div class="container-12">
                        <div class="list-item-link">
                            <img class="vector-9" src="../assets/vectors/vector6_x2.svg" />
                        </div>
                        <div class="list-item-link-1">
                            <img class="vector-10" src="../assets/vectors/vector11_x2.svg" />
                        </div>
                        <div class="container-7">
                            <div class="list-item-link-2">
                                <img class="vector-11" src="../assets/vectors/vector13_x2.svg" />
                            </div>
                            <div class="list-item-link-3">
                                <img class="vector-12" src="../assets/vectors/vector20_x2.svg" />
                            </div>
                        </div>
                        <div class="list-item-link-4">
                            <img class="vector-13" src="../assets/vectors/vector17_x2.svg" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="divheader-secondary-outer">
            <div class="list-1">
                <div class="item-link">
                    <img class="vector-15" src="../assets/vectors/vector21_x2.svg" />
                </div>
                <div class="item-link-1">
                    <img class="vector-16" src="../assets/vectors/vector14_x2.svg" />
                </div>
                <div class="item-link-2">
                    <img class="vector-17" src="../assets/vectors/vector3_x2.svg" />
                </div>
                <div class="item-link-3">
                    <img class="vector-18" src="../assets/vectors/vector8_x2.svg" />
                </div>
                <div class="item-link-4">
                    <img class="vector-19" src="../assets/vectors/vector18_x2.svg" />
                </div>
            </div>
            <div style="display: flex; justify-content: center;" class="list-2">
                <span class="item-link-kunjungi-ketelsuruan-produk">
                    Kunjungi Ketertelusuran Produk
                </span>
                <div class="item-link-5">
                    <img class="vector-20" src="../assets/vectors/vector9_x2.svg" />
                </div>
            </div>
        </div>
    </div>
